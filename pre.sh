...
# run
adb shell cmd activity attach-agent 24041 /data/user/0/skynet.cputhrottlingtest/libjvmti_agent.so=Generic::CYCLES:precise=2@100000000
...
# run
# adb shell cmd activity attach-agent 26651 /data/user/0/com.primatelabs.geekbench5/libjvmti_agent.so=Generic::CYCLES:precise=2@100000000
...
# run
# adb shell cmd activity attach-agent 3816 /data/user/0/com.futuremark.pcmark.android.benchmark/libjvmti_agent.so=Generic::CYCLES:precise=2@100000000