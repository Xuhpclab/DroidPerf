...
//    static WP_TriggerAction_t OnReuseDistanceWatchPoint(WP_TriggerInfo_t *wpi);
...
//    static void ReuseDistanceAnalysis(int event_idx, perf_sample_data_t *sampleData, void *uCtxt, jmethodID method_id, uint32_t method_version, uint32_t threshold, int metric_id1);
