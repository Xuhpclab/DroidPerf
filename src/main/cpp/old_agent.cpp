...
JNIEXPORT jint JNICALL Agent_OnAttach(JavaVM *vm, char *options,
    ...
    SetEventNotification(jvmti_env, JVMTI_ENABLE, JVMTI_EVENT_VM_INIT);

    jint res;
//    res = vm->GetEnv((void **) &_jvmti, JVMTI_VERSION_1_0);
//    _jvmti->SetEventNotificationMode(JVMTI_ENABLE, JVMTI_EVENT_VM_INIT, (jthread)NULL);
